...
UART_HandleTypeDef* toHalHandle(Stm32::UsartInstance instance) {
    ...
    // Return the device handle, which will be nullptr if the instance was not found.
    return deviceHandle;
}
